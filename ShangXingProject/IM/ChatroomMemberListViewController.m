//
//  ChatroomMemberListViewController.m
//  ShangXingProject
//
...
@interface ChatroomMemberListViewController ()<UITableViewDataSource,UITableViewDelegate,NIMChatManagerDelegate>
...
@implementation ChatroomMemberListViewController
...
- (void)viewDidLoad{
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(memberInfoDidUpdate:) name:NIMKitUserInfoHasUpdatedNotification object:nil];
}
...
- (void)memberInfoDidUpdate:(NSNotification *)notification
{
